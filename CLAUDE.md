...
- **Proposition** (https://github.com/jakorten/Proposition.git) - Perspective paper on engineering fidelity framework
- This paper provides the **technical methodology**; the Proposition paper provides the **conceptual framework**
